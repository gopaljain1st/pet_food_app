...
public class Supplements extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Supplements");
      ...
      //  recyclerView=findViewById(R.id.recycle_view_salt_and_sugar);
        ...
        progressDialog=new ProgressDialog(Supplements.this,R.style.MyAlertDialogStyle);
        ...
        StringRequest request=new StringRequest(Request.Method.POST, apiurl, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (sucess.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (category.equals("Supplements")) {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Supplements.this, ""+error, Toast.LENGTH_SHORT).show();
            }
        });
